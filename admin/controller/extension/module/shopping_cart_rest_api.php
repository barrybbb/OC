...
class ControllerExtensionModuleShoppingCartRestApi extends Controller {
    ...
    private function installHtaccess() {
        ...
        $newHtaccess = str_replace("RewriteCond %{REQUEST_FILENAME} !-f" , implode( "\n", array(
            ...
            'RewriteRule ^api/rest/products/slug/?([-a-zA-Z0-9\s/.]+) index.php?route=feed/rest_api/products&slug=$1  [L]',
            '#REST API add review',
            ...
            'RewriteRule ^api/rest/categories/slug/?([-a-zA-Z0-9\s/.]+) index.php?route=feed/rest_api/categories&slug=$1  [L]',
